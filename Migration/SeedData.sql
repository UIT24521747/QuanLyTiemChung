...
INSERT INTO LOVACXIN (MaLo, MaVacXin, MaPhieuNhap, HangSanXuat, NgayHetHan, SoLuongNhap, SoLuongTon, DonGia) VALUES
    -- Phieu 1 lots
    ('LO001', 'VX250101000100001', 'PN250110000100001', 'Pfizer (Mỹ)',           '2029-06-30', 100, 100, 350000.00),
    ('LO002', 'VX250101000200002', 'PN250110000100001', 'Sanofi (Pháp)',         '2029-01-15',  50,  50, 250000.00),
    ('LO003', 'VX250101000300003', 'PN250110000100001', 'Merck Sharp (Đức)',     '2029-03-31',  80,  80, 200000.00),
    ('LO004', 'VX250101000400004', 'PN250110000100001', 'GlaxoSmithKline (Anh)', '2029-09-30',  60,  60, 420000.00),
    -- Phieu 2 lots
    ('LO005', 'VX250101000500005', 'PN250301000100001', 'Bio Farma (Indonesia)', '2029-06-30', 120, 120, 180000.00),
    ('LO006', 'VX250101000600006', 'PN250301000100001', 'Vabiotech (Việt Nam)',  '2029-12-31',  70,  70, 290000.00),
    ('LO007', 'VX250101000100001', 'PN250301000100001', 'Moderna (Mỹ)',          '2029-08-31',  90,  90, 380000.00);
...
INSERT INTO CHITIETTIEM (MaPhieuTiem, MaLo, SoLuong, DonGia, ThanhTien) VALUES
    -- Jan: COVID Pfizer
    ('PT260105000100001', 'LO001', 1, 350000.00, 350000.00),
    -- Feb: Cúm mùa
    ('PT260210000100001', 'LO002', 1, 250000.00, 250000.00),
    -- Mar: Viêm gan B + MMR
    ('PT260315000100001', 'LO003', 1, 200000.00, 200000.00),
    ('PT260315000100001', 'LO004', 1, 420000.00, 420000.00),
    -- Apr: Uốn ván
    ('PT260405000100001', 'LO005', 1, 180000.00, 180000.00),
    -- May: Viêm não NB
    ('PT260510000100001', 'LO006', 1, 290000.00, 290000.00),
    -- Jun 01 KH1: COVID Pfizer
    ('PT260601000100001', 'LO001', 1, 350000.00, 350000.00),
    -- Jun 01 KH3: Cúm mùa
    ('PT260601000200002', 'LO002', 1, 250000.00, 250000.00),
    -- Jun 15 KH5: COVID Pfizer + Viêm gan B + MMR
    ('PT260615000100001', 'LO001', 1, 350000.00, 350000.00),
    ('PT260615000100001', 'LO003', 1, 200000.00, 200000.00),
    ('PT260615000100001', 'LO004', 1, 420000.00, 420000.00),
    -- Jul: COVID Moderna
    ('PT260710000100001', 'LO007', 1, 380000.00, 380000.00),
    -- Aug: Viêm gan B + Uốn ván
    ('PT260805000100001', 'LO003', 1, 200000.00, 200000.00),
    ('PT260805000100001', 'LO005', 1, 180000.00, 180000.00),
    -- Sep: MMR
    ('PT260910000100001', 'LO004', 1, 420000.00, 420000.00),
    -- Oct: Viêm não NB
    ('PT261005000100001', 'LO006', 1, 290000.00, 290000.00),
    -- Nov: COVID Pfizer + COVID Moderna
    ('PT261110000100001', 'LO001', 1, 350000.00, 350000.00),
    ('PT261110000100001', 'LO007', 1, 380000.00, 380000.00),
    -- Dec: Cúm mùa + Uốn ván
    ('PT261215000100001', 'LO002', 1, 250000.00, 250000.00),
    ('PT261215000100001', 'LO005', 1, 180000.00, 180000.00);
...
UPDATE LOVACXIN SET SoLuongTon = 96  WHERE MaLo = 'LO001';
UPDATE LOVACXIN SET SoLuongTon = 47  WHERE MaLo = 'LO002';
UPDATE LOVACXIN SET SoLuongTon = 77  WHERE MaLo = 'LO003';
UPDATE LOVACXIN SET SoLuongTon = 57  WHERE MaLo = 'LO004';
UPDATE LOVACXIN SET SoLuongTon = 117 WHERE MaLo = 'LO005';
UPDATE LOVACXIN SET SoLuongTon = 68  WHERE MaLo = 'LO006';
UPDATE LOVACXIN SET SoLuongTon = 88  WHERE MaLo = 'LO007';
